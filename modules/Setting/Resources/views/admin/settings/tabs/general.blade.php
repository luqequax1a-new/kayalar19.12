<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::checkbox('two_factor_auth_enabled', trans('setting::attributes.two_factor_auth_enabled'), trans('setting::settings.form.enable_two_factor_auth'), $errors, $settings) }}
    </div>
</div>
