...
<body>
    <div class="wrapper">
        <div class="container">
            <div class="header">
                <h1>❤️ شكراً على مراجعتك</h1>
                <div class="subtitle">{{ setting('store_name') }}</div>
            </div>
            
            <div class="content">
                <div class="greeting">
                    {{ $order->customer_first_name }} {{ $order->customer_last_name }}, كوبونك جاهز!
                </div>
                ...
                <div class="coupon-box">
                    <div class="coupon-badge">
                        ⚠️ ملاحظة: القسيمة للاستخدام مرة واحدة
                    </div>
                    
                    <div class="coupon-label">قسيمة الخصم الخاصة بك</div>
                    ...
                    <div class="coupon-details">
                        ...
                        <div class="coupon-detail-item">
                            🗓️ صالح حتى: <strong>{{ optional($coupon->end_date)->format('d.m.Y') }}</strong>
                        </div>
                    </div>
                </div>
                ...
                <p style="margin-top: 30px; font-size: 14px; color: #64748b;">
                    يمكنك استخدام القسيمة في صفحة السلة. تسوق سعيد! 🎉
                </p>
            </div>
