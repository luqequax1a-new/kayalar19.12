<section x-data="CarouselProducts()" class="grid-products-wrap carousel-products-wrap">
    <div class="container">
        <div class="grid-products-wrap-inner carousel-products-inner">
            @if (! empty($carouselProducts2['title']))
                @php
                    $tag = setting('storefront_carousel_section_2_title_tag', 'h3');
                    $align = setting('storefront_carousel_section_2_title_align', 'left');
                    $weight = setting('storefront_carousel_section_2_title_weight');
                    $size = setting('storefront_carousel_section_2_title_size');
                    $color = setting('storefront_carousel_section_2_title_color');
                    $decoration = setting('storefront_carousel_section_2_title_decoration');
                    $style = setting('storefront_carousel_section_2_title_style');
                    $family = setting('storefront_carousel_section_2_title_family');
                    $marginTop = setting('storefront_carousel_section_2_title_margin_top');
                    $marginBottom = setting('storefront_carousel_section_2_title_margin_bottom');
                    $divider = (bool) setting('storefront_carousel_section_2_title_divider', false);
                ...
                <div class="tab-products-header text-{{ $align }}"{!! $headerStyleAttr !!}>
                    {!! "<{$tag} class=\"section-title" . (! $divider ? ' section-title--no-divider' : '') . "\"{$styleAttr}>" . e($carouselProducts2['title']) . "</{$tag}>" !!}
            ...
            <div class="tab-content">
                @php
                    $autoplay = setting('storefront_carousel_section_2_autoplay');
                    $autoplaySpeed = (int) (setting('storefront_carousel_section_2_autoplay_speed') ?: 3000);

                    $perRowMobile = (int) (setting('storefront_carousel_section_2_per_row_mobile') ?: 2);
                    $perRowTablet = (int) (setting('storefront_carousel_section_2_per_row_tablet') ?: 3);
                    $perRowDesktop = (int) (setting('storefront_carousel_section_2_per_row_desktop') ?: 5);

                    $showDots = (bool) setting('storefront_carousel_section_2_show_dots', true);
                    $showArrows = (bool) setting('storefront_carousel_section_2_show_arrows', true);
                @endphp
