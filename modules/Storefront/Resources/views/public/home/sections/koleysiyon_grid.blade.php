        ...
        <div class="container">
            <div class="koleysiyon-grid-inner">
                <div class="koleysiyon-grid-header">
                    @if (! empty($koleysiyonGrid['title']))
                        <h2 class="koleysiyon-grid-title">{{ $koleysiyonGrid['title'] }}</h2>
                    @endif

                    @if (! empty($koleysiyonGrid['subtitle']))
                        <p class="koleysiyon-grid-subtitle">{{ $koleysiyonGrid['subtitle'] }}</p>
                    @endif
                </div>
                ...
                >
                    <div class="koleysiyon-grid-list swiper-wrapper">
                        @foreach ($koleysiyonGrid['items'] as $item)
                            <a
