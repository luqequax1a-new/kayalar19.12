...
Route::get('storefront/carousel-products', 'CarouselProductController@index')->name('storefront.carousel_products.index');
Route::get('storefront/carousel-products-2', 'CarouselProduct2Controller@index')->name('storefront.carousel_products_2.index');
