...
Route::put('storefront/product-page-sections/order', [
    'as' => 'admin.storefront.product_page_sections.order.update',
    'uses' => 'StorefrontController@updateProductPageSectionsOrder',
    'middleware' => 'can:admin.storefront.edit',
]);
