            ...
            @hasAccess('admin.orders.index')
                <div class="dashboard-panel dashboard-analytics" data-dashboard-analytics>
                    ...
                    <div class="dashboard-analytics-tab-panels">
                        ...
                        <div class="tab-panel" data-panel="order_status">
                            <div class="canvas">
                                <canvas class="chart" data-chart-order-status height="280"></canvas>
                            </div>
                        </div>
        ...
        <div class="col-md-5">
            ...
            @hasAccess('admin.products.index')
                <div class="dashboard-panel dashboard-top-products">
                    <div class="grid-header clearfix">
                        <h5 class="pull-left" data-top-col-title>En Çok Satanlar</h5>

                        <div class="pull-right dashboard-top-entities-tabs" data-top-entities-tabs>
                            <a href="#" class="range active" data-entity-tab="products">Ürünler</a>
                            <a href="#" class="range" data-entity-tab="categories">Kategoriler</a>
                    ...
                    <div class="dashboard-top-products-scroll">
                        <div class="table-responsive dashboard-top-products-table">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th data-top-entity-header>Ürün</th>
            ...
            @hasAccess('admin.products.index')
                <div class="dashboard-panel dashboard-stock-status">
                    <div class="grid-header clearfix">
                        <h5 class="pull-left">Stok Durumu</h5>
                    </div>
                    <div class="dashboard-stock-status-content" style="padding: 15px 20px;">
                        <canvas data-chart-stock-status height="180"></canvas>
                    </div>
                </div>
            @endHasAccess
